...
const inexpensiveFlowers = () => {
    ...
    // for loop to enter flowers
    for (const currentFlower of flowers) {
        // write condition for flower price
        if (currentFlower.price < 2)
            filteredFlowers.push(currentFlower)
    }
...
const zoneFlowers = () => {
    ...
    //for loop to enter flowers
    for (const currentFlower of flowers) {
        // write condition for the usdaZones 3 & 8
        if (currentFlower.usdaZones.includes(3) && currentFlower.usdaZones.includes(8))
            filteredFlowers.push(currentFlower)
    }
...
const orangeFlowers = () => {
    ...
    // for loop to enter flowers
    for (const currentFlower of flowers) {
        // write condition for the color orange
        if (currentFlower.colors.includes("Orange"))
            filteredFlowers.push(currentFlower)
    }
